...
const app = new Hono()
  ...
  .post(
    ...
    async (c) => {
      ...
      // Use checkout.session.completed to capture customer information or initiate post-checkout processes
      ...
      // Use invoice.payment_succeeded to confirm payment and update subscription status
